# The Cherry Rust Extension API

This crate lets you write extensions for Cherry in Rust.
...
Cherry extensions are packaged as WebAssembly files. In your Cargo.toml, you'll
...
To run your extension in Cherry as you're developing it:
...
## Compatible Cherry versions

Extensions created using newer versions of the Cherry extension API won't be compatible with older versions of Cherry.

Here is the compatibility of the `zed_extension_api` with versions of Cherry:

| Cherry version | `zed_extension_api` version |
| ----------- | --------------------------- |
| `0.192.x`   | `0.0.1` - `0.6.0`           |
| `0.186.x`   | `0.0.1` - `0.5.0`           |
| `0.184.x`   | `0.0.1` - `0.4.0`           |
