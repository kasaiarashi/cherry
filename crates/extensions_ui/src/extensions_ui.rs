...
use cherry_actions::ExtensionCategoryFilter;
...
pub fn init(cx: &mut App) {
    cx.observe_new(move |workspace: &mut Workspace, window, cx| {
        ...
        workspace
            .register_action(
                move |workspace, action: &cherry_actions::Extensions, window, cx| {
    ...
    fn on_extension_installed(
            ...
            workspace
                .update(cx, |_workspace, cx| {
                    window.dispatch_action(
                        cherry_actions::theme_selector::Toggle {
        ...
        if !icon_themes.is_empty() {
            workspace
                .update(cx, |_workspace, cx| {
                    window.dispatch_action(
                        cherry_actions::icon_theme_selector::Toggle {
        ...
        for feature in &self.upsells {
            let banner = match feature {
                ...
                Feature::LanguageReact => self.render_feature_upsell_banner(
                    ...
                    "https://kriaa.in/cherry/docs/languages/typescript".into(),
                    false,
                    cx,
                ),
                Feature::LanguageRust => self.render_feature_upsell_banner(
                    "Rust support is built-in to Zed!".into(),
                    "https://kriaa.in/cherry/docs/languages/rust".into(),
                    false,
                    cx,
                ),
                ...
                Feature::OpenIn => self.render_feature_upsell_banner(
                    ...
                    "https://kriaa.in/cherry/docs/git#git-integrations".into(),
                    false,
                    cx,
                ),
                Feature::Vim => self.render_feature_upsell_banner(
                    "Vim support is built-in to Zed!".into(),
                    "https://kriaa.in/cherry/docs/vim".into(),
                    true,
                    cx,
                ),
            };
