...
pub fn register(workspace: &mut Workspace) {
    workspace.register_action(|workspace, branch: &cherry_actions::git::Branch, window, cx| {
...
pub fn checkout_branch(
    ...
    _: &cherry_actions::git::CheckoutBranch,
    window: &mut Window,
    cx: &mut Context<Workspace>,
) {
    open(workspace, &cherry_actions::git::Branch, window, cx);
}

pub fn switch(
    workspace: &mut Workspace,
    _: &cherry_actions::git::Switch,
    window: &mut Window,
    cx: &mut Context<Workspace>,
) {
    open(workspace, &cherry_actions::git::Branch, window, cx);
