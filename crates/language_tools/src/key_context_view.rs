                ...
                h_flex()
                    ...
                    .child(
                        Button::new("open_documentation", "Open Documentation")
                            ...
                            .on_click(|_, _, cx| cx.open_url("https://kriaa.in/cherry/docs/key-bindings")),
                    )
                    .child(
                        Button::new("view_default_keymap", "View Default Keymap")
                            ...
                            .on_click(|_, window, cx| {
                                window.dispatch_action(cherry_actions::OpenDefaultKeymap.boxed_clone(), cx);
                            }),
                    )
                    .child(
                        Button::new("edit_your_keymap", "Edit Keymap File")
                            .style(ButtonStyle::Filled)
                            .key_binding(ui::KeyBinding::for_action(&cherry_actions::OpenKeymapFile, cx))
                            .on_click(|_, window, cx| {
