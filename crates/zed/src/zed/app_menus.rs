...
pub fn app_menus(cx: &mut App) -> Vec<Menu> {
    ...
    let mut view_items = vec![
        MenuItem::action(
            "Zoom In",
            cherry_actions::IncreaseBufferFontSize { persist: false },
        ),
        MenuItem::action(
            "Zoom Out",
            cherry_actions::DecreaseBufferFontSize { persist: false },
        ),
        MenuItem::action(
            "Reset Zoom",
            cherry_actions::ResetBufferFontSize { persist: false },
        ),
        MenuItem::action(
            "Reset All Zoom",
            cherry_actions::ResetAllZoom { persist: false },
        ),
        MenuItem::separator(),
        ...
        MenuItem::separator(),
        MenuItem::action("Project Panel", cherry_actions::project_panel::ToggleFocus),
    ...
    vec![
        Menu {
            name: "Cherry".into(),
            items: vec![
                MenuItem::action("About Cherry", cherry_actions::About),
                ...
                MenuItem::submenu(Menu {
                    ...
                    items: vec![
                        ...
                        MenuItem::separator(),
                        MenuItem::action("Open Keymap", cherry_actions::OpenKeymap),
                        MenuItem::action("Open Keymap File", cherry_actions::OpenKeymapFile),
                        MenuItem::action(
                        ...
                        MenuItem::action(
                            "Select Theme...",
                            cherry_actions::theme_selector::Toggle::default(),
                        ),
                        MenuItem::action(
                            "Select Icon Theme...",
                            cherry_actions::icon_theme_selector::Toggle::default(),
                        ),
                    ],
                }),
                MenuItem::separator(),
                ...
                MenuItem::separator(),
                MenuItem::action("Extensions", cherry_actions::Extensions::default()),
                #[cfg(not(target_os = "windows"))]
                MenuItem::action("Install CLI", install_cli::InstallCliBinary),
                MenuItem::separator(),
                #[cfg(target_os = "macos")]
                MenuItem::action("Hide Cherry", super::Hide),
                #[cfg(target_os = "macos")]
                MenuItem::action("Hide Others", super::HideOthers),
                #[cfg(target_os = "macos")]
                MenuItem::action("Show All", super::ShowAll),
                MenuItem::separator(),
                MenuItem::action("Quit Cherry", Quit),
            ],
        },
        Menu {
            name: "File".into(),
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::action(
                    ...
                    cherry_actions::outline::ToggleOutline,
                ),
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::action("Edit debug.json...", cherry_actions::OpenProjectDebugTasks),
                MenuItem::separator(),
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::action("View Telemetry", cherry_actions::OpenTelemetryLog),
