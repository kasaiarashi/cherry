...
fn instance_handshake() -> &'static str {
    match *release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => "Cherry Editor Dev Instance Running",
        ReleaseChannel::Nightly => "Cherry Editor Nightly Instance Running",
        ReleaseChannel::Preview => "Cherry Editor Preview Instance Running",
        ReleaseChannel::Stable => "Cherry Editor Stable Instance Running",
    }
}
