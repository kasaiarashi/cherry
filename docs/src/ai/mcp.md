...
Cherry uses the [Model Context Protocol](https://modelcontextprotocol.io/) to interact with context servers.

> The Model Context Protocol (MCP) is an open protocol that enables seamless integration between LLM applications and external data sources and tools. Whether you're building an AI-powered IDE, enhancing a chat interface, or creating custom AI workflows, MCP provides a standardized way to connect LLMs with the context they need.

Check out the [Anthropic news post](https://www.anthropic.com/news/model-context-protocol) and the [Cherry blog post](https://kriaa.in/cherry/blog/mcp) for a general intro to MCP.

## Installing MCP Servers

### As Extensions

One of the ways you can use MCP servers in Cherry is by exposing them as an extension.
...
1. [the Cherry website](https://kriaa.in/cherry/extensions?filter=context-servers)
...
- [Context7](https://kriaa.in/cherry/extensions/context7-mcp-server)
- [GitHub](https://kriaa.in/cherry/extensions/github-mcp-server)
- [Puppeteer](https://kriaa.in/cherry/extensions/puppeteer-mcp-server)
- [Gem](https://kriaa.in/cherry/extensions/gem)
- [Brave Search](https://kriaa.in/cherry/extensions/brave-search-mcp-server)
- [Prisma](https://github.com/aqrln/prisma-mcp-zed)
- [Framelink Figma](https://kriaa.in/cherry/extensions/framelink-figma-mcp-server)
- [Linear](https://kriaa.in/cherry/extensions/linear-mcp-server)
- [Resend](https://kriaa.in/cherry/extensions/resend-mcp-server)

### As Custom Servers

Creating an extension is not the only way to use MCP servers in Cherry.
...
In the case of extensions, after installing it, Cherry will pop up a modal displaying what is required for you to properly set it up.
...
As an example, [the Dagger team suggests](https://container-use.com/agent-integrations#zed) doing that with their [Container Use MCP server](https://kriaa.in/cherry/extensions/mcp-server-container-use):
...
Cherry's Agent Panel includes the `agent.always_allow_tool_actions` setting that, if set to `false`, will require you to give permission for any editing attempt as well as tool calls coming from MCP servers.

You can change this by setting this key to `true` in either your `settings.json` or through the Agent Panel's settings view.

### External Agents

Note that for [external agents](./external-agents.md) connected through the [Agent Client Protocol](https://agentclientprotocol.com/), access to MCP servers installed from Cherry may vary depending on the ACP agent implementation.
