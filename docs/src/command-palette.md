...
The Command Palette is the main way to access pretty much any functionality that's available in Cherry. Its keybinding is the first one you should make yourself familiar with. To open it, hit: {#kb command_palette::Toggle}.

![The opened Command Palette](https://kriaa.in/cherry/img/features/command-palette.jpg)
