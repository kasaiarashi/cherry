# Building Cherry for FreeBSD

Note, FreeBSD is not currently a supported platform, and so this is a work-in-progress.

## Repository

Clone the [Cherry repository](https://github.com/zed-industries/zed).
...
See [Issue #15309: FreeBSD Support] and [Discussion #29550: Unofficial FreeBSD port for Cherry] for more.
