...
Cherry gets its diagnostics from the language servers and supports both push and pull variants of the LSP which makes it compatible with all existing language servers.

# Regular diagnostics

By default, Cherry displays all diagnostics as underlined text in the editor and the scrollbar.
...
Cherry supports showing diagnostic as lens to the right of the code.
