...
Cherry offers an automatic way to create debug scenarios with _debug locators_.
...
Check out all the DAP servers that have already been exposed as extensions [on Cherry's site](https://kriaa.in/cherry/extensions?filter=debug-adapters).
