...
Extensions may provide icon themes in order to change the icons Cherry uses for folders and files.
...
Each icon theme file should adhere to the JSON schema specified at [`https://kriaa.in/cherry/schema/icon_themes/v0.3.0.json`](https://kriaa.in/cherry/schema/icon_themes/v0.3.0.json).

Here is an example of the structure of an icon theme:

```json [icon-theme]
{
  "$schema": "https://kriaa.in/cherry/schema/icon_themes/v0.3.0.json",
  "name": "My Icon Theme",
  "author": "Your Name",
  "themes": [
    {
