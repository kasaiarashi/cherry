...
Cherry comes with a built-in icon theme, with more icon themes available as extensions.
...
More icon themes are available from the Extensions page, which you can access via the command palette with `zed: extensions` or the [Cherry website](https://kriaa.in/cherry/extensions?filter=icon-themes).
...
Just like with themes, Cherry allows for configuring different icon themes for light and dark mode.
...
See: [Developing Cherry Icon Themes](./extensions/icon-themes.md)
