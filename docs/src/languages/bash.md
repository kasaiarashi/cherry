...
Bash language support in Cherry is provided by the community-maintained [Basher extension](https://github.com/d1y/bash.zed).
...
- [Cherry Docs: Language Support: Shell Scripts](./sh.md)
