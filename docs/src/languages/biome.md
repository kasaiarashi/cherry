...
[Biome](https://biomejs.dev/) support in Cherry is provided by the community-maintained [Biome extension](https://github.com/biomejs/biome-zed).
...
See the [Biome Cherry Extension README](https://github.com/biomejs/biome-zed) for a complete list of features and configuration options.
