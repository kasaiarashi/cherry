...
To use [LÖVE (Love2D)](https://love2d.org/) in Cherry, checkout [LuaCATS/love2d](https://github.com/LuaCATS/love2d) into a folder called `love2d-luacats` into the parent folder of your project:
...
To use [Playdate Lua SDK](https://play.date/dev/) in Cherry, checkout [playdate-luacats](https://github.com/notpeter/playdate-luacats) into the parent folder of your project:
...
To enable [Inlay Hints](../configuring-languages.md#inlay-hints) for LuaLS in Cherry

1. Add the following to your Cherry settings.json:
...
Then add the following to your Cherry `settings.json`:
