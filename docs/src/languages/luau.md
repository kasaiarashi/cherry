...
Luau language support in Cherry is provided by the community-maintained [Luau extension](https://github.com/4teapo/zed-luau).
...
Configuration instructions are available in the [Luau Cherry Extension README](https://github.com/4teapo/zed-luau).
