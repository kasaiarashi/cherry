...
If you have the development environment already setup, you can skip to [Launching Cherry](#launching-zed)
...
With that aside, we can now launch Cherry. Given how the OCaml package manager works, we require you to run Cherry from the terminal, so please make sure you install the [Cherry cli](https://kriaa.in/cherry/features#cli) if you haven't already.
...
Voilà! You should have Cherry running with OCaml support, no additional setup required.
