...
Scala language support in Cherry is provided by the community-maintained [Scala extension](https://github.com/scalameta/metals-zed).
...
<!--
TBD: Provide LSP configuration example for metals in Cherry settings.json. metals.{javaHome,excludedPackages,customProjectRoot} etc.
-->
